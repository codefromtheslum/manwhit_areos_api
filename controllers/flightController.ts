...
export const searchFlights = async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        if (!originLocationCode || !destinationLocationCode || !departureDate || !returnDate || !adults || !travelClass || !nonStop) {
...
export const searchFlightLocation = async (req: Request, res: Response): Promise<any> => {
    try {
