...
exports.sendLoginEmail = exports.sendResetPassword = exports.sendVerification = void 0;
  ...
  >
    <div style="max-width: 600px; margin: 0 auto; padding: 20px">
      ...
      <div style="text-align: center">
        <a
          href="http://localhost:5173/auth/${user.id}"
          target="_blank"
          style="
      ...
      <div style="font-weight: 500; max-width: 90%">
        ...
        >
          ...
          <a
            ...
            href="http://localhost:5173/auth/${user.id}/complete"
            target="_blank"
...
const sendLoginEmail = (user) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const accessTokenResponse = yield OAuth.getAccessToken();
        const accessToken = accessTokenResponse === null || accessTokenResponse === void 0 ? void 0 : accessTokenResponse.token;
  ...
  >
    <div style="max-width: 600px; margin: 0 auto; padding: 20px">
      ...
      <div style="font-weight: 500; max-width: 90%">
        <div>Hey there,</div>
        <div>
          We received a request to login to your account
        </div>
        <div>
          Click the link below to login to your. The link will expire in
          15 minutes for your security:
        </div>
        <div
          style="
        ...
        >
          ...
          <a
            style="text-decoration: none; color: blue"
            href="http://localhost:5173/auth/${user === null || user === void 0 ? void 0 : user.email}/complete"
            target="_blank"
            >Login Account</a
          >
        </div>
